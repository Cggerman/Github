...
-->
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-4 ml-auto text-center mb-5 mb-lg-0">
          ...
          <div>+1 (514) 884-9439</div>
        </div>
        <div class="col-lg-4 mr-auto text-center">
          <i class="fas fa-envelope fa-3x mb-3 text-muted"></i>
          <!-- Make sure to change the email address in anchor text AND the link below! -->
          <a class="d-block" href="mailto:contact@yourwebsite.com">contact@go-web.ca</a>
          <a class="d-block" href="mailto:contact@yourwebsite.com">go-web.ca@hotmail.com</a>
  ...
  <footer class="bg-light py-5">
    <div class="container">
      <div class="small text-center text-muted">Copyright &copy; 2017 - GO-WEB.CA </div>
    </div>
  </footer>
